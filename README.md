...
| Readability and simplicity pass | [clean-code](/skills/clean-code/SKILL.md)                                                                                                                              | Human-scale design, naming, complexity, comments                                          |
| Review the diff                 | [review](/skills/review/SKILL.md)                                                                                                                                      | Read actual diff, tier feedback, agent-diff checks, apply fixes                           |
...
| Confirm shared understanding    | [rtfm](/skills/rtfm/SKILL.md)                                                                                                                                          | Explain verified work, quiz understanding, test before advice                            |
...
| Fix code bloaters               | [refactoring](/skills/refactoring/SKILL.md)                                                                                                                            | Tidy just in time; detect long methods, large classes, primitive obsession               |
