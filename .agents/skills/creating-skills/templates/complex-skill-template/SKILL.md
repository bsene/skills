...
See REFERENCE.md section [X] for detailed methodology on [specific topic].
...
**Using Templates:**
See FORMS.md for output templates.
...
**Advanced Details:**
See REFERENCE.md section "[Pattern 3 Details]" for:
- Advanced techniques
- Edge case handling
...
For output templates and examples, see FORMS.md.
